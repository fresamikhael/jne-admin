...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <form method="POST" action="{{ route('headDept-approve', $item->id_permit) }}" class="mt-3" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select name="approval_status" class="form-control dropdown dropdown-toggle">
                                <option value="PENDING">Belum Approve</option>
                                <option value="AP1">Approve</option>
                            </select>
                        </div>
                    </div>
