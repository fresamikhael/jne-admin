...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <form method="POST" action="{{ route('inpg-update', $item->id_permit) }}" class="mt-3" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" name="dokumen3" value="LENGKAP" readonly>
                        </div>
                        <div class="col-lg-6">
