...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <form method="POST" action="{{ route('inpg-post', $item->id_permit) }}" class="mt-3" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <input type="hidden" class="form-control" name="complete_status" value="CLOSE" readonly>
                        </div>
                        <div class="col-lg-6">
                            <label>Upload SKPD</label>
                            <input type="file" class="form-control" name="skpd">
                        </div>
                        <div class="col-lg-6">
                            <label>Bukti Pembayaran 1</label>
                            <input type="file" class="form-control" name="bukti1">
                        </div>
                        <div class="col-lg-6">
                            <label>Bukti Pembayaran 2</label>
                            <input type="file" class="form-control" name="bukti2">
                        </div>
                        <div class="col-lg-12">
                            <label>Catatan</label>
                            <textarea class="form-control" name="catatan">Permohonan pengajuan reklame telah selesai, Silahkan download file SKPD sebagai arsip apabila ada pemeriksaan dari instansi berwenang.</textarea>
                        </div>
                    </div>
